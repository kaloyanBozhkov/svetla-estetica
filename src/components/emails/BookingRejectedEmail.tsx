        ...
        <Container style={container}>
          ...
          <Section style={box}>
            ...
            <Text style={paragraph}>
              Purtroppo non siamo in grado di confermare il tuo appuntamento per la data e
              l&apos;ora richieste.
            </Text>
            ...
            <Text style={paragraph}>
              Ci scusiamo per l&apos;inconveniente! Puoi prenotare una nuova data direttamente
              online oppure contattarci per assistenza.
            </Text>
