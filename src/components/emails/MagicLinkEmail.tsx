        ...
        <Container style={container}>
          ...
          <Section style={box}>
            ...
            <Text style={paragraph}>
              Hai richiesto un link di accesso al tuo account Svetla Estetica. Clicca il pulsante
              qui sotto per accedere:
            </Text>
            <Button style={button} href={magicLinkUrl}>
              Accedi al tuo account
            </Button>
            <Text style={smallText}>
              Questo link scadrà tra 15 minuti. Se non hai richiesto questo link, puoi ignorare
              questa email.
            </Text>
            <Hr style={hr} />
            <Text style={footer}>
