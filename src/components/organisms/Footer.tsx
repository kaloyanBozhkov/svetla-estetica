    ...
    <footer className="relative bg-gray-900 text-gray-300 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Centro estetico professionale a Dalmine, Bergamo.
              Trattamenti per viso e corpo, prodotti di qualità.
            </p>
          ...
          <div>
            <h4 className="font-semibold text-white mb-4">Orario</h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+393935026350" className="hover:text-primary-400">
                  (+39) 393 5026 350
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+390350632279" className="hover:text-primary-400">
                  (+39) 035 0632279
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/393935026350" target="_blank" rel="noopener noreferrer" className="hover:text-green-400">
                  WhatsApp
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/prodotti" className="hover:text-primary-400">
                  Prodotti
                </Link>
              </li>
              <li>
                <Link href="/trattamenti" className="hover:text-primary-400">
                  Trattamenti
                </Link>
              </li>
              <li>
                <Link href="/chi-siamo" className="hover:text-primary-400">
                  Chi Siamo
                </Link>
              </li>
              <li>
                <Link href="/contatti" className="hover:text-primary-400">
                  Contatti
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center text-sm">
          <p>© {currentYear} Svetla Estetica. Tutti i diritti riservati.</p>
        </div>
      </div>
    </footer>
  );
