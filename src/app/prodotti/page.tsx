...
export const metadata: Metadata = {
  ...
  description:
    'Scopri la nostra selezione di prodotti professionali per la cura della pelle e del corpo. Creme viso, prodotti corpo, solari, tisane, profumi e molto altro.',
  openGraph: {
