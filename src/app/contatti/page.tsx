...
export const metadata: Metadata = {
  ...
  description:
    'Contatta Svetla Estetica a Dalmine, Bergamo. Orari di apertura, telefono, indirizzo e social media. Prenota il tuo appuntamento!',
  openGraph: {
    title: 'Contatti | Svetla Estetica, Dalmine Bergamo',
    description: 'Trova Svetla Estetica a Dalmine. Orari, telefono e come raggiungerci.',
  },
  alternates: {
    canonical: '/contatti',
  },
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-lg text-primary-100">
              Siamo nel cuore di Dalmine. Contattaci per qualsiasi informazione o per prenotare il
              tuo trattamento.
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-600 to-primary-700 p-8 shadow-lg transition-all hover:shadow-xl">
                ...
                <div className="relative text-white">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="font-display text-2xl font-bold">Contattaci</h2>
                  </div>
                  <ul className="space-y-6">
                    ...
                    <li>
                      <p className="text-sm text-primary-200 mb-1">WhatsApp</p>
                      <a
                        href="https://wa.me/393935026350"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xl font-bold hover:text-green-400 transition-colors flex items-center gap-2"
                      >
                        (+39) 393 5026 350
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 p-8 shadow-lg transition-all hover:shadow-xl">
                ...
                <div className="relative text-white">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="font-display text-2xl font-bold">Seguici</h2>
                  </div>
            ...
            <div className="space-y-8">
              ...
              <div className="rounded-2xl bg-gradient-to-br from-primary-600 to-primary-800 p-8 text-center text-white shadow-lg">
                <h3 className="font-display text-2xl font-bold">Prenota il Tuo Appuntamento</h3>
