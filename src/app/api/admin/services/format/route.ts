...
const SYSTEM_MESSAGE = `You are a text formatter for an Italian aesthetics center website. Your task is ONLY to format text, NOT to change its meaning or content.
