...
const values = [
  {
    ...
    description: "Oltre 15 anni di esperienza nel settore estetico, formazione continua e attenzione ai dettagli.",
    icon: (
  ...
  {
    title: "Qualità",
    description: "Solo prodotti certificati e tecnologie all'avanguardia per risultati visibili e duraturi.",
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Benessere",
    description: "Un'oasi di relax dove prenderti cura di te stessa, lontano dallo stress quotidiano.",
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-primary-100 max-w-2xl leading-relaxed">
              Da oltre 15 anni, Svetla Estetica è il punto di riferimento per chi cerca 
              trattamenti estetici di qualità a Dalmine. Un luogo dove professionalità, 
              passione e attenzione al cliente si fondono per regalarti momenti di puro relax.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-gray-600 leading-relaxed">
                <p>
                  ...
                  per la bellezza e il benessere. Situato nel cuore di Dalmine, il nostro centro 
                  è diventato negli anni un punto di riferimento per chi cerca trattamenti 
                  estetici di qualità in un ambiente familiare e professionale.
                </p>
                <p>
                  Crediamo che ogni persona sia unica e meriti cure personalizzate. 
                  Per questo, ascoltiamo attentamente le esigenze di ogni cliente, 
                  creando percorsi di bellezza su misura che valorizzano la tua 
                  unicità naturale.
                </p>
                <p>
                  La nostra filosofia è semplice: farti sentire speciale, rilassata 
                  e più bella, ogni volta che varchi la nostra porta.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="order-2 lg:order-1">
              <div className="grid grid-cols-2 gap-4">
                {["Viso", "Corpo", "Solari", "Profumi"].map((cat, i) => (
                  ...
                  >
                    <p className={`font-display text-lg font-bold ${i % 2 === 0 ? "text-gray-900" : ""}`}>
                      {cat}
                    </p>
                    <p className={`mt-1 text-sm ${i % 2 === 0 ? "text-gray-500" : "text-primary-100"}`}>
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Oltre ai trattamenti in cabina, offriamo una selezione curata di prodotti 
                per la cura quotidiana della pelle e del corpo. Creme, solari, tisane, 
                profumi e molto altro - tutti scelti per garantirti risultati professionali anche a casa.
              </p>
              <div className="mt-8">
                <Link href="/prodotti">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 p-12 text-center text-white shadow-2xl">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-lg text-primary-100 max-w-xl mx-auto">
                Ti aspettiamo nel nostro centro per un&apos;esperienza di benessere unica. 
                Prenota il tuo appuntamento o passa a trovarci!
              </p>
